...
async def entrypoint(ctx: JobContext):
    ...
    logging.info(f"Recording started:{os.getenv("S3_BUCKET_NAME")}{os.getenv("AWS_DEFAULT_REGION")} {os.getenv("AWS_ACCESS_KEY_ID")} {os.getenv("AWS_SECRET_ACCESS_KEY")} {res}")
